...
const Rule_CONJ003& Rule_CONJ003::instance()
{
    static Rule_CONJ003 inst;
    return inst;
}
                                        ...
                                        const CheckerRuntime& /*runtime*/) const
{
    ...
    if (anchor.upos == Upos::SConj && lemmaLower == QStringLiteral("although")) {
        ...
        ce.conflictTokenIds = {anchor.id};
        {
            ...
            edit.newTokens.append(QStringLiteral("despite"));
    ...
    if (anchor.upos == Upos::Adp &&
        ...
        ce.conflictTokenIds = {anchor.id};
        {
            ...
            edit.type = AtomicEditType::ReplaceTokens;
            edit.targetTokenIds = {anchor.id};
            edit.newTokens.append(QStringLiteral("although"));
            ce.edits.append(edit);
        }
