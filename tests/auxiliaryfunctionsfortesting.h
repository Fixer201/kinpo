...
/*!
* \brief Найти директорию со словарями docs/lists.
* \return Абсолютный путь к docs/lists или пустая строка, если не найдена.
*
* Перебирает несколько относительных путей, чтобы работало
* при запуске тестов из любой директории сборки.
*/
